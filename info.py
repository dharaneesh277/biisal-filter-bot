...
#main variables
API_ID = int(environ.get('API_ID', '25119491'))
API_HASH = environ.get('API_HASH', '3c5ddacccd76c4907d00900a7fca9260')
BOT_TOKEN = environ.get('BOT_TOKEN', '7500843151:AAGOydRmHNiVSMew8QPeUZBmRW9YLBLGj0g')

ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6436860642').split()]
USERNAME = environ.get('USERNAME', "https://telegram.me/biisal")
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001589790858'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+4RB2-U2o9yE4ZmQ9')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '').split()]
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Tarun:dharunthedon@cluster0.vipoq.mongodb.net/")

DATABASE_NAME = environ.get('DATABASE_NAME', "TELEGRAM_BOT_INFO")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002330737263'))
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002214030352'))
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002355267757'))
...
REF_PREMIUM = 30
PREMIUM_POINT = 1500
auth_channel = environ.get('AUTH_CHANNEL', ' -1002268257344')
...
UPI_PAY_LOGS = int(environ.get('UPI_PAY_LOGS', '-1002281656232'))
